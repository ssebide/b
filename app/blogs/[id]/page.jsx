    ...
    return (data ? <>
        ...
        <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
            ...
            <div className='my-24'>
                ...
                <div className='flex'>
                    <Image src={assets.facebook_icon} width={50} alt='social media' />
                    <Image src={assets.twitter_icon} width={50} alt='social media' />
                    <Image src={assets.googleplus_icon} width={50} alt='social media' />
                </div>
            </div>
        </div>
        <Footer />
